                ...
                <div class="row d-flex">
                    <div class="col-lg-6">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" value="<?php echo $firstname;?>"name="firstname" id="floating-user-fname"
                    ...
                    <div class="col-lg-6">
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" value="<?php echo $lastname;?>"name="lastname" id="floating-user-lname"
                    ...
                    <div class="col-lg-6">
                        <div class="form-floating mb-3">
                            <input type="number" class="form-control" value="<?php echo $number;?>"name="number" id="floating-user-email"
                    ...
                    <div class="col-lg-12">
                        <div class="form-floating mb-3"><input type="text" class="form-control" value="<?php echo $adress;?>"name="adress"
                                id="floating-user-con-pass" placeholder="Address" required>
                    ...
                    <div class="cols-lg-12">
                        ...
                        <div class="form-floating">
                            <textarea class="form-control" value="<?php echo $specialneed;?>"name="specialneed" placeholder="Give your special needs"
                                id="specialneed"></textarea>
