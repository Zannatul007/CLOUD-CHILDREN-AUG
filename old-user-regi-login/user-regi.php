                ...
                <div class="row d-flex">
                    <div class="col-lg-6">
                        <div class="form-floating mb-3">
                            ...
                            <label for="floating-firstname"><span style="color:red;font-size:1rem ;">*<?php echo $firstnameErr; ?></span></span> First
                                Name</label>
                        </div>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-4 ms-auto me-auto align-item-center">
                        <input type="submit" value="Sign Up" name="register" class="form-btn btn btn-primary w-100">
                    </div>
                </div>
            </form>
        </div>
