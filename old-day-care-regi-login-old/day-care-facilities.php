    ...
    <div class="form-sec outer-box container">
        ...
        <div class="row d-flex align-items-center">
            ...
            if (isset($_POST["register"])) {
                ...
                if ($foodErr != "Fill this Field!" && $medicationErr != "Fill this Field!" && $entertainmentErr != "Fill this Field!" && $transportationErr != "Fill this Field!" && $sanitaryErr != "Fill this Field!") {   //update users set username='JACK' and password='123' WHERE id='1';
            ...
            <form class="daycare-form col-lg-6" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                <div class="container mt-5 mb-5">
                    ...
                    <div class="col-lg-4 ms-auto me-auto">
                        <input type="submit" name="register" value="NEXT" class="form-btn btn btn-primary w-100">
                    </div>
                </div>
